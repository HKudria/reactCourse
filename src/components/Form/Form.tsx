        ...
        <div className={s.wrapper}>
            <form className={s.form} onSubmit={handleSubmit(onSubmit)}>
                <div className="form-group">
                    ...
                    <input type="text" className="form-control" id="text" placeholder="Enter text" data-testid="text"
                           {...register('text', {required: true})}/>
                    {errors.text && <div className="invalid-feedback d-block">Fill the text</div>}
                </div>
                <div className="form-group">
                    <label htmlFor="date" className="form-label">Select date</label>
                    <input type="date" className="form-control" id="date" {...register('date', {required: true})} data-testid="date"/>
                ...
                <div className="form-check">
                    ...
                    <input type="checkbox" className="form-check-input"
                           id="checkbox" {...register('checkbox', {required: true})} data-testid="checkbox"/>
                ...
                <div className="form-group">
                    ...
                    <select className="form-select form-select-sm" {...register('select', {required: true})} data-testid="select">
                        <option></option>
                ...
                <div className="form-group">
                    ...
                    <input type="file" className="form-control" id="file" {...register('file', {required: true})} data-testid="file"/>
                    {errors.file && <div className="invalid-feedback d-block" data-testid='error'>File should be uploaded</div>}
                </div>
                <div className="form-check">
                    <input className="form-check-input" type="radio" value="radio1"
                           id="flexRadioDefault1" {...register('switcher', {required: true})} data-testid="switch"/>
            ...
            <div className={s.formResult} data-testid='result'>
